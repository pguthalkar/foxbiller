...
export class AddUserComponent implements OnInit {
  ...
  private executeOwnerCreation = (userFormValue) => {
    ...
    //   code: userFormValue.code, 
    //   role: userFormValue.role, 
    //   company: userFormValue.company, 
    //   address: userFormValue.address,
    //   addressDetail: userFormValue.addressDetail,
    //   city: userFormValue.city,
    //   country: userFormValue.country,
    //   state: userFormValue.state,
    //   postalCode: userFormValue.postalCode,
    //   meterId: userFormValue.meterId,
    //   meterType: userFormValue.meterType
    // }
